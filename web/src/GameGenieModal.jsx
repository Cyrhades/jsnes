      ...
      >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div>
                <label className="block text-[11px] font-semibold text-slate-300 mb-1">
                  Code (6/8 lettres ou Hex)
                </label>
                <input
                  type="text"
                  value={inputCode}
                  onChange={(e) => setInputCode(e.target.value)}
                  placeholder="ex: AAUNYLPA"
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="ex: Chrono gelé / Vies inf."
                        ...
                        {item.decoded && (
                          <div className="text-[10px] text-slate-500 font-mono mt-0.5">
                            ...
                            {item.decoded.value
                              ...
                              .toUpperCase()
                              .padStart(2, "0")}
                            {item.decoded.key !== undefined &&
                              ` | Key: $${item.decoded.key.toString(16).toUpperCase().padStart(2, "0")}`}
                          </div>
                        )}
                      </div>
                    </div>
        ...
        <div className="flex items-center justify-between px-6 py-4 border-t border-slate-800 bg-slate-950/80 shrink-0">
          <p className="text-[11px] text-slate-400">
            Supporte les codes Game Genie 6/8 lettres et les patchs Hex
            ($ADDR:$VAL)
          </p>
          <button
            type="button"
